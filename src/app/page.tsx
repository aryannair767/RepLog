            ...
            <div className="md:col-span-8 bg-[#1c1b1b] rounded-xl p-6 sm:p-10 flex flex-col border border-white/5 transition-all hover:border-[#84cc16]/20 min-h-[400px]">
              <Reveal delay={0} className="h-full">
                <div className="flex flex-col md:flex-row gap-8 h-full">
                  ...
                  <div className="flex-1 w-full min-h-[300px] bg-[#0e0e0e] rounded-lg border border-white/5 p-6 flex flex-col justify-between">
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-1 h-5 bg-[#84cc16] rounded-full"></div>
                      <span className="text-sm sm:text-base font-bold text-white uppercase tracking-widest">UPPER BODY PERFORMANCE MATRIX</span>
                    </div>
