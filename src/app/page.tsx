...
function BentoCard({
  ...
  return (
    <Reveal delay={delay} className="h-full">
      <div className="flex flex-col justify-between p-10 h-full min-h-[400px] border border-white/5 bg-[#1c1b1b] rounded-xl transition-all duration-300 hover:border-[#84cc16]/20">
        <div>
          {/* Icon */}
  ...
  return (
    <div className="min-h-screen bg-[#131313] text-[#e5e2e1] font-sans selection:bg-[#84cc16] selection:text-[#161e00]">
      ...
      <main className="pt-32">
        {/* ── HERO ──────────────────────────────────────────── */}
        <section ref={heroRef} className="px-8 mb-24 md:mb-40 max-w-7xl mx-auto">
          <motion.div style={{ y: heroY, opacity: heroOpacity }} className="flex flex-col gap-6">
            ...
            <Reveal delay={0.4}>
              <div className="mt-4 flex flex-col md:flex-row gap-4">
                <Link
                  href="/dashboard"
                  className="kinetic-gradient text-[#161e00] px-8 py-4 rounded-md font-bold uppercase tracking-widest text-sm hover:opacity-90 transition-all flex items-center justify-center gap-2"
                >
                  Get Started
        ...
        <section className="px-8 mb-40 max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            {/* Feature 2: Sync */}
            <div className="md:col-span-4 bg-[#353534] rounded-xl p-10 flex flex-col border border-white/5 transition-all hover:border-[#84cc16]/20">
            ...
            {/* Feature 3: Insights */}
            <div className="md:col-span-12 bg-[#201f1f] rounded-xl p-10 flex flex-col md:flex-row gap-12 items-center border border-white/5 transition-all hover:border-[#84cc16]/20">
              ...
              <Reveal className="flex-1 w-full h-full min-h-[300px] bg-[#0e0e0e] rounded-lg border border-white/5 p-6 flex flex-col justify-center" delay={0.3}>
        ...
        <section className="py-40 bg-[#1c1b1b]/50">
          <Reveal>
      ...
      <footer className="bg-[#131313] w-full py-20 border-t border-[#444933]/15">
        <div className="max-w-7xl mx-auto px-8">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8 border-t border-white/5 pt-12">
            <div className="text-[0.6875rem] uppercase tracking-[0.1em] text-[#c4c9ac]">
